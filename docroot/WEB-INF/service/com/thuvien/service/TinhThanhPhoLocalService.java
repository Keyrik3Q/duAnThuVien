...
/**
 * Provides the local service interface for TinhThanhPho. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ADMIN
 * @see TinhThanhPhoLocalServiceUtil
...
public interface TinhThanhPhoLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TinhThanhPhoLocalServiceUtil} to access the tinh thanh pho local service. Add custom service methods to {@link com.thuvien.service.impl.TinhThanhPhoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
