...
/**
 * Provides the local service interface for TheLoai. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ADMIN
 * @see TheLoaiLocalServiceUtil
...
public interface TheLoaiLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TheLoaiLocalServiceUtil} to access the the loai local service. Add custom service methods to {@link com.thuvien.service.impl.TheLoaiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
