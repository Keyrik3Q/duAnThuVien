 ...
 * @generated
 */
public class TheLoaiLocalServiceClp implements TheLoaiLocalService {
	public TheLoaiLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public com.thuvien.model.TheLoai addTheLoai(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(theLoai) });
		}
		catch (Throwable t) {
		...
		return (com.thuvien.model.TheLoai)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<com.thuvien.model.TheLoai> getTheLoais(int start,
		...
		return (java.util.List<com.thuvien.model.TheLoai>)ClpSerializer.translateOutput(returnObj);
	}
