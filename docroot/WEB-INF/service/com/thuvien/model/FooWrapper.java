...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
	...
	*/
	...
	@Override
	public int compareTo(com.thuvien.model.Foo foo) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.thuvien.model.Foo> toCacheModel() {
		return _foo.toCacheModel();
	}

	@Override
	public com.thuvien.model.Foo toEscapedModel() {
		return new FooWrapper(_foo.toEscapedModel());
	}

	@Override
	public com.thuvien.model.Foo toUnescapedModel() {
