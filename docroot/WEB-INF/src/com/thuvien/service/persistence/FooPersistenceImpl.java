...
import com.thuvien.NoSuchFooException;

import com.thuvien.model.Foo;
import com.thuvien.model.impl.FooImpl;
import com.thuvien.model.impl.FooModelImpl;
...
public class FooPersistenceImpl extends BasePersistenceImpl<Foo>
	...
	@Override
	public Foo updateImpl(com.thuvien.model.Foo foo) throws SystemException {
		foo = toUnwrappedModel(foo);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.thuvien.model.Foo")));
