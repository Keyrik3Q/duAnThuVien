...
import com.thuvien.service.GiaHanLocalService;
...
/**
 * Provides the base implementation for the gia han local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.thuvien.service.impl.GiaHanLocalServiceImpl}.
 * </p>
 *
 * @author ADMIN
 * @see com.thuvien.service.impl.GiaHanLocalServiceImpl
 * @see com.thuvien.service.GiaHanLocalServiceUtil
 * @generated
 */
public abstract class GiaHanLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements GiaHanLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.thuvien.service.GiaHanLocalServiceUtil} to access the gia han local service.
	 */
	...
	@Override
	public GiaHan addGiaHan(GiaHan giaHan) throws SystemException {
		giaHan.setNew(true);

		return giaHanPersistence.update(giaHan);
	}
	 ...
	 */
	@Override
	public GiaHan createGiaHan(long IdGh) {
		return giaHanPersistence.create(IdGh);
	}
	...
	@Override
	public GiaHan deleteGiaHan(long IdGh)
		throws PortalException, SystemException {
		return giaHanPersistence.remove(IdGh);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GiaHan deleteGiaHan(GiaHan giaHan) throws SystemException {
		return giaHanPersistence.remove(giaHan);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GiaHan.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return giaHanPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return giaHanPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return giaHanPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return giaHanPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public GiaHan fetchGiaHan(long IdGh) throws SystemException {
		return giaHanPersistence.fetchByPrimaryKey(IdGh);
	}
	 ...
	 */
	@Override
	public GiaHan getGiaHan(long IdGh) throws PortalException, SystemException {
		return giaHanPersistence.findByPrimaryKey(IdGh);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return giaHanPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GiaHan> getGiaHans(int start, int end)
		throws SystemException {
		return giaHanPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getGiaHansCount() throws SystemException {
		return giaHanPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GiaHan updateGiaHan(GiaHan giaHan) throws SystemException {
		return giaHanPersistence.update(giaHan);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.thuvien.model.GiaHan",
			giaHanLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.thuvien.model.GiaHan");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = giaHanPersistence.getDataSource();
	...
	private GiaHanLocalServiceClpInvoker _clpInvoker = new GiaHanLocalServiceClpInvoker();
}